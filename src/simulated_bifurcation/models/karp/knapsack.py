...
class Knapsack(BinaryPolynomial):
    ...
    def __init__(self, weights: List[int], costs: List[Union[int, float]], max_weight: int, dtype: torch.dtype = torch.float32, device: str = 'cpu') -> None:
