...
def minimize(matrix: Union[Tensor, ndarray], vector: Union[Tensor, ndarray] = None, constant: float = None,
    ...
    model = build_model(matrix=matrix, vector=vector, constant=constant, input_type=input_type, dtype=dtype, device=device)
...
def build_model(matrix: Union[Tensor, ndarray], vector: Union[Tensor, ndarray], constant: float, input_type: str, dtype: dtype, device: str) -> IsingInterface:
